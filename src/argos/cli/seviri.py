...
Command line interface for SEVIRI data extraction.
"""
import calendar
...
from argos.data.seviri import seviri_obs, seviri_io_obs
...
def extract_seviri_data(
    ...
    """
    Extract SEVIRI data for specified time period using multiprocessing.
    
    Args:
        satellite: Satellite name ('seviri' or 'seviri_io')
...
def seviri(
    ...
    """Extract SEVIRI satellite observation data.
    
    SATELLITE: Satellite to extract data from (seviri, seviri_io)
    YEAR: Year to extract data for
    ...
    try:
        ...
        LOGGER.info("SEVIRI data extraction completed successfully")
