...
Command line interface for HIMAWARI data extraction.
"""
import calendar
...
from argos.data.himawari import himawari8_obs, himawari9_obs
...
SATELLITES = {
    'himawari8': himawari8_obs,
    'himawari9': himawari9_obs
}
...
def extract_himawari_data(
    ...
    """
    Extract HIMAWARI data for specified time period using multiprocessing.
    
    Args:
        satellite: Satellite name ('himawari8' or 'himawari9')
...
def himawari(
    ...
    """Extract HIMAWARI satellite observation data.
    
    SATELLITE: Satellite to extract data from (himawari8, himawari9)
    YEAR: Year to extract data for
    ...
    try:
        ...
        LOGGER.info("HIMAWARI data extraction completed successfully")
