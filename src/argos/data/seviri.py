            ...
            try:
                ...
                for rec in recs:
                    ...
                    for chan_ind, chan in enumerate(channels):
                        if chan == "HRV":
                            data = seviri_obs[[chan, "latitude_1", "longitude_1"]].rename(
                                latitude_1="latitude",
                                longitude_1="longitude"
                            )
                        else:
                            data = seviri_obs[[chan, "latitude_0", "longitude_0"]].rename(
                                latitude_0="latitude",
                        ...
                        data_r = resample_data(data, grid, info=info, radius_of_influence=10e3)
                        if chan == "HRV":
                            info = None
